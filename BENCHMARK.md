...
```json
{
  ...
  "source_sha256": "4f1e7494c002b5a9771f8754f707af66a829924bf1ba9383e5e155675ee29fc9",
  "scoring_method": {
    ...
    "batch_metric_policy": "P.2, P.3, RP.1 and RP.2 are report-only"
  },
  "dimensions": [
    {
      "dimension_id": "P", "version": "0.3.0-draft", "name": "模型性能与基础可用性", "parent_dimension": null, "status": "shadow",
    ...
    {
      "dimension_id": "E1", "version": "0.3.0-draft", "name": "Prompt文字遵循", "parent_dimension": "E", "status": "shadow",
      "definition": "判断Prompt文字要求做什么以及是否做对，不以参考相似度或画面美观代替。", "applicable_modes": ["both"], "score_type": "mean_applicable_criteria_0_2",
    ...
    {
      "dimension_id": "E2", "version": "0.3.0-draft", "name": "Feed遵循与编辑边界", "parent_dimension": "E", "status": "shadow",
      "definition": "第一项只管单帧/局部空间编辑范围与残留；第二项只管跨帧动态和时间结构保持，不重复扣分。", "keywords": ["编辑边界", "漏改", "误改"], "applicable_modes": ["both"], "score_type": "mean_applicable_criteria_0_2",
    ...
    {
      "dimension_id": "E4", "version": "0.3.0-draft", "name": "自然度、结构与时序完成度", "parent_dimension": "E", "status": "shadow",
      "definition": "集中评价主观合理性、自然度、协调性和AI味；G1/G2已评价的模糊、卡顿和闪烁不重复扣分。", "applicable_modes": ["both"], "score_type": "mean_applicable_criteria_0_2",
      "required_evidence": ["feed_evidence", "prompt", "result_evidence"],
      "judge_routing": {"primary_kinds": ["mlmm"], "secondary_kinds": [], "fallback_policy": "no_automated_judge"},
      "criteria": [
        {"criterion_id": "E4.1", "name": "人体、物体与实例结构", "definition": "结构、数量和接触关系应合理稳定。", "score_type": "integer_0_2", "anchors": {"0": {"description": "持续出现多肢、关节反折、融化、实例复制/消失或严重穿模。"}, "1": {"description": "整体结构合理，仅在快速运动或遮挡时出现一次局部瑕疵。"}, "2": {"description": "人体、物体和实例数量全程结构合理，在运动和遮挡中也稳定。"}}},
  ...
  "reporting_metrics": [
    ...
    {"metric_id": "RP.1", "version": "0.3.0-draft", "name": "启动与画面交付", "scope": "frozen_realtime_batch", "applicable_modes": ["realtime"], "definition": "统计会话建立、远程首帧、首个有效结果、有效FPS、掉帧、重复帧和冻结的覆盖率与分布。"},
  ...
  "weight_profiles": [
    {"profile_id": "scene-base-offline-0.3", "version": "0.3.0-draft", "status": "shadow", "applicable_modes": ["offline"], "description": "仅供场景规则覆盖的实现基底，不构成通用权重。", "implementation_base_only": true, "weights": {"G1": 1, "G2": 1, "G3": 1, "E1": 1, "E2": 1, "E3": 1, "E4": 1}, "maximum_rule_multiplier": 100},
    {"profile_id": "scene-base-realtime-0.3", "version": "0.3.0-draft", "status": "shadow", "applicable_modes": ["realtime"], "description": "仅供场景规则覆盖的实现基底，不构成通用权重。", "implementation_base_only": true, "weights": {"G1": 1, "G2": 1, "G3": 1, "E1": 1, "E2": 1, "E3": 1, "E4": 1, "R1": 1, "R2": 1}, "maximum_rule_multiplier": 100}
  ],
  "scene_weight_rules": [
    {"rule_id": "core-indoor-selfie-person-replacement-offline", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-offline-0.3"], "when": {"all": [{"scenario_id": "core-indoor-selfie-person-replacement"}, {"mode": "offline"}]}, "weight_overrides": {"G1": 12, "G2": 8, "G3": 4, "E1": 15, "E2": 15, "E3": 21, "E4": 25}},
    {"rule_id": "core-indoor-selfie-person-replacement-realtime", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-realtime-0.3"], "when": {"all": [{"scenario_id": "core-indoor-selfie-person-replacement"}, {"mode": "realtime"}]}, "weight_overrides": {"G1": 10, "G2": 7, "G3": 3, "E1": 14, "E2": 12, "E3": 18, "E4": 20, "R1": 6, "R2": 10}},
    {"rule_id": "core-outdoor-complex-person-replacement-offline", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-offline-0.3"], "when": {"all": [{"scenario_id": "core-outdoor-complex-person-replacement"}, {"mode": "offline"}]}, "weight_overrides": {"G1": 12, "G2": 10, "G3": 3, "E1": 12, "E2": 14, "E3": 18, "E4": 31}},
    {"rule_id": "core-outdoor-complex-person-replacement-realtime", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-realtime-0.3"], "when": {"all": [{"scenario_id": "core-outdoor-complex-person-replacement"}, {"mode": "realtime"}]}, "weight_overrides": {"G1": 10, "G2": 8, "G3": 2, "E1": 12, "E2": 12, "E3": 15, "E4": 24, "R1": 5, "R2": 12}},
    {"rule_id": "core-pet-realtime-interaction-realtime", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-realtime-0.3"], "when": {"all": [{"scenario_id": "core-pet-realtime-interaction"}, {"mode": "realtime"}]}, "weight_overrides": {"G1": 7, "G2": 9, "G3": 3, "E1": 10, "E2": 8, "E3": 10, "E4": 25, "R1": 10, "R2": 18}},
    {"rule_id": "core-pet-replacement-offline", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-offline-0.3"], "when": {"all": [{"scenario_id": "core-pet-replacement"}, {"mode": "offline"}]}, "weight_overrides": {"G1": 11, "G2": 9, "G3": 3, "E1": 13, "E2": 13, "E3": 22, "E4": 29}},
    {"rule_id": "core-pet-replacement-realtime", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-realtime-0.3"], "when": {"all": [{"scenario_id": "core-pet-replacement"}, {"mode": "realtime"}]}, "weight_overrides": {"G1": 9, "G2": 7, "G3": 2, "E1": 12, "E2": 10, "E3": 20, "E4": 23, "R1": 5, "R2": 12}},
    {"rule_id": "core-high-speed-subject-edit-offline", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-offline-0.3"], "when": {"all": [{"scenario_id": "core-high-speed-subject-edit"}, {"mode": "offline"}]}, "weight_overrides": {"G1": 10, "G2": 15, "G3": 5, "E1": 11, "E2": 12, "E3": 17, "E4": 30}},
    {"rule_id": "core-high-speed-subject-edit-realtime", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-realtime-0.3"], "when": {"all": [{"scenario_id": "core-high-speed-subject-edit"}, {"mode": "realtime"}]}, "weight_overrides": {"G1": 8, "G2": 12, "G3": 4, "E1": 10, "E2": 10, "E3": 14, "E4": 24, "R1": 6, "R2": 12}},
    {"rule_id": "core-travel-vlog-scene-style-offline", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-offline-0.3"], "when": {"all": [{"scenario_id": "core-travel-vlog-scene-style"}, {"mode": "offline"}]}, "weight_overrides": {"G1": 10, "G2": 13, "G3": 5, "E1": 12, "E2": 17, "E3": 18, "E4": 25}},
    {"rule_id": "core-multishot-film-replacement-offline", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-offline-0.3"], "when": {"all": [{"scenario_id": "core-multishot-film-replacement"}, {"mode": "offline"}]}, "weight_overrides": {"G1": 9, "G2": 14, "G3": 5, "E1": 18, "E2": 15, "E3": 17, "E4": 22}},
    {"rule_id": "core-fixed-camera-multi-subject-replacement-offline", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-offline-0.3"], "when": {"all": [{"scenario_id": "core-fixed-camera-multi-subject-replacement"}, {"mode": "offline"}]}, "weight_overrides": {"G1": 9, "G2": 9, "G3": 3, "E1": 19, "E2": 16, "E3": 19, "E4": 25}},
    {"rule_id": "core-fixed-camera-multi-subject-replacement-realtime", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-realtime-0.3"], "when": {"all": [{"scenario_id": "core-fixed-camera-multi-subject-replacement"}, {"mode": "realtime"}]}, "weight_overrides": {"G1": 8, "G2": 7, "G3": 2, "E1": 17, "E2": 13, "E3": 17, "E4": 21, "R1": 4, "R2": 11}},
    {"rule_id": "core-moving-camera-added-subject-interaction-realtime", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-realtime-0.3"], "when": {"all": [{"scenario_id": "core-moving-camera-added-subject-interaction"}, {"mode": "realtime"}]}, "weight_overrides": {"G1": 8, "G2": 8, "G3": 2, "E1": 12, "E2": 8, "E3": 12, "E4": 26, "R1": 8, "R2": 16}},
    {"rule_id": "core-moving-camera-effects-offline", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-offline-0.3"], "when": {"all": [{"scenario_id": "core-moving-camera-effects"}, {"mode": "offline"}]}, "weight_overrides": {"G1": 10, "G2": 10, "G3": 3, "E1": 15, "E2": 12, "E3": 15, "E4": 35}},
    {"rule_id": "core-moving-camera-effects-realtime", "version": "0.3.0-draft", "status": "shadow", "priority": 100, "applicable_profile_ids": ["scene-base-realtime-0.3"], "when": {"all": [{"scenario_id": "core-moving-camera-effects"}, {"mode": "realtime"}]}, "weight_overrides": {"G1": 8, "G2": 8, "G3": 2, "E1": 14, "E2": 10, "E3": 12, "E4": 27, "R1": 7, "R2": 12}}
  ],
  "hard_gates": [
  ...
  "score_schemas": [
    {"score_schema_id": "xmax-scene-score-0.3", "version": "0.3.0-draft", "status": "shadow",
      "dimensions": [{"dimension_id": "G1", "aggregation": "mean_applicable_criteria"}, {"dimension_id": "G2", "aggregation": "mean_applicable_criteria"}, {"dimension_id": "G3", "aggregation": "mean_applicable_criteria"}, {"dimension_id": "E1", "aggregation": "mean_applicable_criteria"}, {"dimension_id": "E2", "aggregation": "mean_applicable_criteria"}, {"dimension_id": "E3", "aggregation": "mean_applicable_criteria"}, {"dimension_id": "E4", "aggregation": "mean_applicable_criteria"}, {"dimension_id": "R1", "aggregation": "mean_applicable_criteria"}, {"dimension_id": "R2", "aggregation": "mean_applicable_criteria"}],
      "weight_profile_by_mode": {"offline": "scene-base-offline-0.3", "realtime": "scene-base-realtime-0.3"}, "require_scene_weight_rule": true, "canonical_score_enabled": false, "outputs": ["scenario_score"], "case_score_output": "scenario_score", "comparison_policy_status": "pending_first_round"}
  ],
  "change_log": [
...
适用于XMAX基于原视频、摄像头流、Prompt文字及单份Prompt图片或视频素材的离线与实时生成，不包含纯文本直接生成视频。当前`benchmark_version = 0.3.0-draft`，全部合同仍为Shadow。

## 2. 评分方法

每条适用细则按0（差）、1（合格）、2（好）评分。每个标准先取适用细则平均档位，再乘场景权重；不适用项从分子、分母同时剔除，其余权重归一化至100%。P.1为0时Run直接记0。P.2/P.3和RP.1/RP.2只进入批次报告。
...
| E1 | Prompt文字遵循 | both | 3 | 是 |
| E2 | Feed遵循与编辑边界 | both | 2 | 是 |
| E3 | Prompt素材遵循 | both | 2 | 有Prompt素材时适用 |
| E4 | 自然度、结构与时序完成度 | both | 3 | 是 |
...
| core-pet-realtime-interaction | realtime | 19 | 53 | 28 |
...
| core-moving-camera-added-subject-interaction | realtime | 18 | 58 | 24 |
| core-moving-camera-effects | offline / realtime | 23 / 18 | 77 / 63 | — / 19 |

精确权重位于16条`scene_weight_rules`中，均与来源文档第3章一致。G3/E3不适用时归一化，不以0分代替。
...
- E1-E4与R2：MLMM直接返回细则分，Fusion派生标准分。
- R1：由交互事件与可见变化时间戳评价；未执行连续交互实验时R1.2不适用。

## 7. 版本与校准要求

首轮至少检查P Gate误触发、G类CV阈值、G3可评覆盖率、E类Judge与人工盲评一致性、R1/R2证据覆盖、场景排序和权重敏感性。调整时创建新版本并Replay旧Run。
